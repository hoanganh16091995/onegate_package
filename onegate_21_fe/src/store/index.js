...
export const store = new Vuex.Store({
  ...
  actions: {
    ...
    addCmtOfficial ({commit, state}, data) {
      var vm = this
      return new Promise((resolve, reject) => {
        const config = {
          headers: {
        ...
        var params = new URLSearchParams()
        params.append('content', data.official_opinion)
        params.append('opinion', true)
        params.append('className', data.class_name)
        params.append('classPK', data.class_pk)
    ...
    deleteCmtOfficial ({commit, state}, data) {
      var vm = this
      return new Promise((resolve, reject) => {
        const config = {
          headers: {
